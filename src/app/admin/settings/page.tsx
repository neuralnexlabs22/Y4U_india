...
export default function AdminSettingsPage() {
  ...
  const [siteName, setSiteName] = useState("Y4U INDIA");
  ...
  const [seoTitle, setSeoTitle] = useState("Y4U INDIA");
  const [seoDescription, setSeoDescription] = useState("Premium modern streetwear, hoodies, tees & outerwear — Y4U INDIA. WEAR UR STORY.");
