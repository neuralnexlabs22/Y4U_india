// Streetwear Brands Database - Tailored for Y4U INDIA
export const allBrands = [
  { name: "Y4U INDIA", category: "hoodies", description: "Premium original streetwear hoodies", featured: true },
  { name: "Y4U INDIA", category: "t-shirts", description: "Original graphic and minimalist tees", featured: true },
  { name: "Y4U INDIA", category: "bottoms", description: "Baggy fit utility bottoms", featured: true },
  { name: "Y4U INDIA", category: "outerwear", description: "Premium outerwear, leather and velvet jackets", featured: true },
  { name: "Y4U INDIA", category: "accessories", description: "Streetwear beanies, chains and essentials", featured: true },
...
export const brandsByCategory = {
  hoodies: [
    { name: "Y4U INDIA", slug: "y4u-india", description: "Premium original streetwear hoodies", category_id: "hoodies", is_active: true },
  ...
  "t-shirts": [
    { name: "Y4U INDIA", slug: "y4u-india", description: "Original graphic and minimalist tees", category_id: "t-shirts", is_active: true },
  ...
  bottoms: [
    { name: "Y4U INDIA", slug: "y4u-india", description: "Baggy fit utility bottoms", category_id: "bottoms", is_active: true },
    { name: "CORTEIZ", slug: "corteiz", description: "Corteiz RTW utility cargos and bottoms", category_id: "bottoms", is_active: true }
  ],
  outerwear: [
    { name: "Y4U INDIA", slug: "y4u-india", description: "Premium outerwear, leather and velvet jackets", category_id: "outerwear", is_active: true },
  ...
  accessories: [
    { name: "Y4U INDIA", slug: "y4u-india", description: "Streetwear beanies, chains and essentials", category_id: "accessories", is_active: true },
